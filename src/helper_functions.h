...
/**
 * Calculate the probability of multi-Gaussian distribution.
 * @param sig_x sigma of variable x.
 * @param sig_y sigma of variable y.
 * @param x_obs observation of x.
 * @param y_obs observation of y.
 * @param mu_x mean of x.
 * @param mu_y mean of y.
 * @output double the probability calculated.
 */
